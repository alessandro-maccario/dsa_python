"""No length of the linked list will be given and you are not allowed to traverse the linked list and calculate the length"""
...
class LinkedList:
    ...
    def binary_to_decimal(self):
        ...
        raised to the power equivalent to the position of the digit,
        counting from right to left starting from 0, and all the results are summed together
        to get the decimal number.

        Returns
        -------
        The binary_to_decimal method returns the calculated decimal number.
        """
        current = self.head
        result = 0
